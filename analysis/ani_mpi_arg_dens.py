...
titles = ["0.001", "0.01", "0.1"]
file_directory = ['s023_regular_r500b8_ref7_0.001', 's021_regular_r500b8_ref7_0.01', 's022_regular_r500b8_ref7_0.1']
directory = 'figure/magtest' + file_directory[0][1:4] + '_dens_' + direction + '_range' + str(region)
...
for i in range(num):
    if (i % size == rank):
        ...
        for j in range(len(file_directory)):
            ...
            p = yt.SlicePlot(ds, direction, 'density', width=(region, "kpc"))
            # p.annotate_grids()
